        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-in-left">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-primary font-semibold">DeltaUpdate</span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 pt-8 border-t border-border/50">
              <div className="text-center">
                <div className="text-3xl font-bold primary-gradient bg-clip-text text-transparent">99%</div>
                <div className="text-sm text-muted-foreground">Réduction de taille</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold primary-gradient bg-clip-text text-transparent">10x</div>
                <div className="text-sm text-muted-foreground">Plus rapide</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold primary-gradient bg-clip-text text-transparent">500+</div>
                <div className="text-sm text-muted-foreground">Projets déployés</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold primary-gradient bg-clip-text text-transparent">24/7</div>
